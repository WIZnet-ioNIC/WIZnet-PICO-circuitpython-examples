...
## Step 4: Setup Adafruit IO Uplink Example
...
4. Connect to Adafruit IO and continue to **send random data** every 5 seconds..
...
5. Copy **Adafruit IO Uplink code** to **code.py** on your RPi Pico and save. Make sure that PC is configured in same subnet 192.168.1.xxx.
